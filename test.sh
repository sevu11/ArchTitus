...
keyboard_selector () {
    input_print "Please insert the keyboard layout to use in console (enter empty to use SV, or \"/\" to look up for keyboard layouts): "
    read -r kblayout
    case "$kblayout" in
        '') kblayout="sv"
            info_print "The standard SV keyboard layout will be used."
            return 0;;
